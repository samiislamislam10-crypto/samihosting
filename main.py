...
[{color}]◎══════════════════════════════════════◎
[FF66CC]◉ —͞⼕SAMIㅤ友! BOT [9400D3]➤ /spnff ◉
"""
    return result
...
def load_credentials_from_file(filename="SAMI.txt"):
    """
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]—͞⼕SAMIㅤ友! [00FF00]___ —͞⼕SAMIㅤ友!____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @SAMI\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]—͞⼕SAMIㅤ友!ㅤ [FFFF00]!!
"""
...
[{color1}]━━━━━━━━━━━━━━━━━━
[FF66CC]◉ —͞⼕SAMIㅤ友! BOT [FF69B4]➤ /joke ◉
[{color1}]━━━━━━━━━━━━━━━━━━
"""
...
[{color}]◎━━━━━━━━━━━━━━━━━━━━━━━━━━━◎
[FFFFFF]{message}
[FF66CC]◉ —͞⼕SAMIㅤ友! BOT [00FF7F]➤ /frt ◉
"""
...
[{color}]◎━━━━━━━━━━━━━━━━━━━━━━━━━━━◎
[FFFFFF]{message}
[FF66CC]◉ —͞⼕SAMIㅤ友! BOT [FF69B4]➤ /grt ◉
"""
...
[{c1}]{prediction}
[{border_color}]━━━━━━━━━━━━━━━━━━━━━
[FF69B4]🔮 Powered By [FFFF00]—͞⼕SAMIㅤ友!
[{border_color}]━━━━━━━━━━━━━━━━━━━━━"""
...
[1E90FF]━━━━━━━━━━━━━━━━━━━━━"""
                        ...
                        if inPuTMsG.startswith('/on'):
                            if not is_admin(uid):
                                await safe_send_message(response.Data.chat_type, "❌ Only SAMI can use /[00FF00]on", uid, chat_id, key, iv, region=region)
                                continue
                        ...
                        if inPuTMsG.startswith('/off'):
                            if not is_admin(uid):
                                await safe_send_message(response.Data.chat_type, "❌ Only SAMI can use /[FF0000]off", uid, chat_id, key, iv, region=region)
                                continue
...
"""
                                ...
                                credentials = load_credentials_from_file("SAMI.txt")
                                if not credentials:
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][FF0000]╔═════════════╗
[FFFFFF] ✨ YT= @doordie1tm FOLLOW   
[FFFFFF]      THANKS FOR USE MY BOT❤️   
[FFFFFF]           AND THANKS FOR YOUR SUPPORT❤️ 
[FF0000]╠═════════════╣
[FF66CC] ⚡ OWNER REAL NAME : [FFFFFF]—͞⼕SAMIㅤ友!
[FF66CC] ✨ কেউ GUILD BOT [FF0000]কিনতে চাইলে message করবেন, [00FFFF] Telegram: @SAMI
[FF0000]╠═════════════╣
[FF66CC] ✨ Developer —͟͞͞ </> —͞⼕SAMIㅤ友! ❄️  ⚡
[FF66CC]╚═════════════╝"""
...
async def MaiiiinE():
    ...
    print("📁 Loading credentials from SAMI.txt...")
    credentials = load_credentials_from_file("SAMI.txt")
    
    if not credentials:
        print("❌ Failed to load credentials!")
        print("💡 Please create SAMI.txt with your UID and password")
